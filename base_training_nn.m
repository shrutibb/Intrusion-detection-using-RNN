function [training_time] = base_training_nn()%max_len,training_data_size,feature_loc,total_epochs,layer_neurons)
...
% for j=i:i+10000
% if ~strcmpi(raw1{j,43},'normal')
%     for k=6:42
%    temp =raw1{j,k};
%    data_set(count,k-5) = temp;
%     end
%    data_class{count,1}=raw1{j,43};
%    count = count+1;
% end 
% end
% end
...
P = feature_vect(1:training_data_size,:)';
...
if acc>=max_acc
    max_acc=acc
save classes_final.mat classes_final
